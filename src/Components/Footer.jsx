...
export default function Footer(){
    return(
        <div className="bg-[#190F00]  text-white py-17.5 px-10 flex justify-between w-screen">

            <div className="flex flex-col gap-4">
                <img src={Swift} alt="swift logo" className = "w-30"/>
                <p className="text-[0.75rem] font-black">&copy;2025, All Rights Reserved. </p>
                <p className="font-medium text-[0.75rem] text-[#ABABAB]">Designed and Developed by SwiftXend, for You!</p>
            </div>
